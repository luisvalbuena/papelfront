      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col justify-center text-center md:text-left">
          ...
          <p className="text-lg text-gray-600 leading-relaxed mb-8">
            En <span className="font-semibold text-pink-600">Mimi Papelerías</span> 
          ...
          <Button
            variant="outline"
            size="md"
            className="w-fit mx-auto md:mx-0 rounded-none border border-pink-600 text-pink-600 hover:bg-pink-600 hover:text-white transition"
          >
            Conócenos
          </Button>
        </div>
