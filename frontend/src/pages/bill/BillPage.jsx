      ...
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Datos personales */}
            <div>
              <h2 className="font-medium text-pink-600 mb-2">
                Datos personales
              </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <input
                  ...
                  className="border border-gray-300 rounded-none p-2 w-full focus:ring-1 focus:ring-pink-600 outline-none"
                />
              ...
              <input
                ...
                onChange={handleChange}
                className="border border-gray-300 rounded-none p-2 w-full mt-4 focus:ring-1 focus:ring-pink-600 outline-none"
              />
            ...
            {/* Dirección */}
            <div>
              <h2 className="font-medium text-pink-600 mb-2">Dirección</h2>
