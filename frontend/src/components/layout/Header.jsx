      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
        ...
        <Link to="/" className="flex items-center gap-2">
          ...
          <span
            ...
            style={{
              fontFamily: `'Great Vibes', 'Allura', 'Lobster Two', cursive`,
              color: "#D9A3A9",
            }}
          >
            Mimi Papelerías
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            to="/cart"
            aria-label="Carrito"
            className="relative text-gray-900 hover:text-pink-600 transition-colors flex items-center gap-1"
          >
            <span className="text-sm font-medium">Mi carrito</span>
            <ShoppingBag size={20} />
            {totalItems > 0 && (
              <span className="absolute -top-1 -right-2 bg-pink-600 text-white text-xs px-1 rounded-full">
                {totalItems}
              </span>
            )}
          </Link>
          ...
          <button
            ...
            className="text-gray-900 md:hidden transition-colors"
          >
